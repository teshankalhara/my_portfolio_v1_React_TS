                ...
                <div className="">
                    ...
                    <div className="">
                        {socialLinks && socialLinks.map((item, key) => {
                            return (
                                <a href={item.href} target="_blank" className="" key={key}>
                                    {item.icon}
                                </a>
                            )
                        })}
                ...
                <form action="" method="POST" className="">
                    <div className="">
                        ...
                        <div className="">
                            ...
                            <input type="email" name="email" id="email" className="text-field" autoComplete="name" placeholder="teshan@email.com" required />
                        </div>
                    </div>
                </form>
            </div>
